...
#define MPU_READ_COMPASS	_IOR(MPU_IOCTL, 0x12, uint8_t)
#define MPU_READ_ACCEL		_IOR(MPU_IOCTL, 0x13, uint8_t)
#define MPU_READ_PRESSURE	_IOR(MPU_IOCTL, 0x14, uint8_t)
...
#define MPU_SUSPEND		_IOW(MPU_IOCTL, 0x30, uint32_t)
#define MPU_RESUME		_IOW(MPU_IOCTL, 0x31, uint32_t)
/* Userspace PM Event response */
#define MPU_PM_EVENT_HANDLED	_IO(MPU_IOCTL, 0x32)

#define MPU_GET_REQUESTED_SENSORS	_IOR(MPU_IOCTL, 0x40, uint32_t)
#define MPU_SET_REQUESTED_SENSORS	_IOW(MPU_IOCTL, 0x40, uint32_t)
#define MPU_GET_IRQ_TO_FIFO_DIVIDER	_IOR(MPU_IOCTL, 0x41, uint16_t)
#define MPU_SET_IRQ_TO_FIFO_DIVIDER	_IOW(MPU_IOCTL, 0x41, uint16_t)
#define MPU_GET_IGNORE_SYSTEM_SUSPEND	_IOR(MPU_IOCTL, 0x42, uint8_t)
#define MPU_SET_IGNORE_SYSTEM_SUSPEND	_IOW(MPU_IOCTL, 0x42, uint8_t)
#define MPU_GET_MLDL_STATUS		_IOR(MPU_IOCTL, 0x43, uint8_t)
#define MPU_GET_I2C_SLAVES_ENABLED	_IOR(MPU_IOCTL, 0x44, uint8_t)
